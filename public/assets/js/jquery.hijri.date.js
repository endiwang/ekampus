...
$.fn.hijriDate = function (options = {}) {
  ...
  const weekDays = {
    ...
    en: ["Ahad", "Isnin", "Selasa", "Rabu", "Khamis", "Jumaat", "Sabtu"]
  };
  const hijriMonths = {
    ar: ["المحرم", "صفر", "ربيع الأول", "ربيع الآخر", "جمادى الأولى", "جمادى الآخرة", "رجب", "شعبان", "رمضان", "شوال", "ذو القعدة", "ذو الحجة"],
    en: ["Muharram", "Safar", "Rabi'ulawal", "Rabi'ulakhir", "Jamadilawwal", "Jamadilakhir", "Rejab", "Sha'ban", "Ramadhan", "Syawal", "Zulqa'idah", "Zullhijjah"]
  };
  const gregMonths = {
    ar: ["يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"],
    en: ["Januari", "Februari", "Mac", "April", "Mei", "Jun", "Julai", "Ogos", "September", "Oktober", "November", "Disember"]
  };
