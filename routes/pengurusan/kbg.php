...
use Illuminate\Support\Facades\Route;
    ...
    Route::post('/senarai_tapisan_permohonan_store_pemohon', [SenaraiTapisanPermohonanController::class, 'store_pemohon'])->name('pengurusan.senarai_tapisan_permohonan.store_pemohon');
