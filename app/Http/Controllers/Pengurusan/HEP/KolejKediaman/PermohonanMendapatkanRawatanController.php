...
class PermohonanMendapatkanRawatanController extends Controller
{
     ...
     */
    protected $baseView = 'pages.pengurusan.hep.kolej_kediaman.permohonan.mendapatkan_rawatan.';
    ...
    public function index(Builder $builder)
    {
        ...
        if (request()->ajax()) {
            $data = PermohonanMendapatkanRawatan::query();
            ...
            return DataTables::of($data)
                ...
                ->addColumn('status_rawatan', function ($data) {
                    switch ($data->status_rawatan) {
                        case 0:
                            return '<span class="badge badge-primary">Belum Dirawat</span>';
                            break;

                        case 1:
                            return '<span class="badge badge-success">Sudah Dirawat</span>';
                            break;
                    }
                })
                ...
                ->addColumn('action', function ($data) {
                        return '
                            <a href="'.route('pengurusan.kolej_kediaman.permohonan.mendapatkan_rawatan.edit', $data->id).'" class="edit btn btn-icon btn-info btn-sm hover-elevate-up mb-1" data-bs-toggle="tooltip" title="Lihat">
                                <i class="fa fa-eye"></i>
                            </a>';
                })
                ->addIndexColumn()
                ...
                ->rawColumns(['status', 'action', 'tarikh_permohonan','nama_pelajar','no_ic','status_rawatan'])
                ->toJson();
        }
        ...
        $dataTable = $builder
            ->columns([
                ...
                ['data' => 'status_rawatan', 'name' => 'status_rawatan', 'title' => 'Status Rawatan', 'orderable' => false],
    ...
    public function edit($id)
    {
        ...
        $action = route('pengurusan.kolej_kediaman.permohonan.mendapatkan_rawatan.update', $id);
        $breadcrumbs = [
            'Kolej Kediaman' => false,
            'Permohonan' => false,
            'Mendapatkan Rawatan' => false,
            'Makluma Permohonan' => false,
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengurusan.kolej_kediaman.permohonan.mendapatkan_rawatan.index');
    }
