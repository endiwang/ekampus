        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ (request()->is('utama')) ? 'here show' : '' }} menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div>
                        <a class="menu-link {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.tetapan.template_jemputan_sijil.index') ? 'active' : '' }}" href="{{ route('pengurusan.pengajian_sepanjang_hayat.tetapan.template_jemputan_sijil.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Template Jemputan Majlis Pensijilan</span>
                        </a>
                    </div>
                </div>
            </div>
