<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.tetapan.*') ? 'here show' : '' }} menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.tetapan.template_sijil_tahfiz.index') ? 'active' : '' }}" href="{{ route('pengurusan.pengajian_sepanjang_hayat.tetapan.template_sijil_tahfiz.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.pemarkahan.*') ? 'here show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.pengurusan_sijil_tahfiz.*') ? 'here show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="menu-title">Pengurusan Sijil Tahfiz</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.pengurusan_sijil_tahfiz.penerima_sijil_tahfiz.*') ? 'active' : '' }}" href="{{ route('pengurusan.pengajian_sepanjang_hayat.pengurusan_sijil_tahfiz.penerima_sijil_tahfiz.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Senarai Penerima Sijil Tahfiz</span>
                        </a>
                    </div>
                </div>
            </div>
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.jemputan.*') ? 'here show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span class="menu-title">Majlis Pensijilan</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.jemputan.jemputan_majlis.*') ? 'active' : '' }}" href="{{ route('pengurusan.pengajian_sepanjang_hayat.jemputan.jemputan_majlis.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Jemputan Majlis Pensijilan</span>
                        </a>
                    </div>
                </div>
            </div>
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.laporan.*') ? 'here show' : '' }} menu-accordion">
                <span class="menu-link">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.pengajian_sepanjang_hayat.laporan.rekod_analisa.*') ? 'active' : '' }}" href="{{ route('pengurusan.pengajian_sepanjang_hayat.laporan.rekod_analisa.index') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Rekod Analisa Zon Peperiksaan</span>
                        </a>
                    </div>
                </div>
            </div>
