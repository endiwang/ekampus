<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
        <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.index') }}" target="blank">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.persiapan_peperiksaan.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.persiapan_peperiksaan.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Persiapan Peperiksaan</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.kemaskini_markah.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.kemaskini_markah.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Kemaskini Markah</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.kemaskini_keputusan.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.kemaskini_keputusan.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Kemaskini Keputusan</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
            ...
            <div class="menu-item">
                ...
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.pengesahan_tamat_pengajian.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.pengesahan_tamat_pengajian.index') }}">
                    ...
                    <span class="menu-title">Pengesahan Tamat Pengajian</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
            ...
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.cetakan_keputusan_peperiksaan.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.cetakan_keputusan_peperiksaan.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Cetak Keputusan Peperiksaan</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.cetakan_transkrip_peperiksaan.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.cetakan_transkrip_peperiksaan.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Cetak Transkrip Peperiksaan</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
                <!--begin:Menu link-->
                <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.cetak_keputusan_penuh.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.cetak_keputusan_penuh.index') }}">
                    <span class="menu-icon">
                        <span class="svg-icon svg-icon-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="2" y="2" width="9" height="9" rx="2" fill="currentColor" />
                    ...
                    <span class="menu-title">Cetak Keputusan Penuh</span>
                </a>
                <!--end:Menu link-->
            </div>
            <div class="menu-item">
            ...
            <div data-kt-menu-trigger="click" class="menu-item {{ Request::routeIs('pengurusan.peperiksaan.kemaskini') ? 'here show' : '' }} menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.kemaskini.senarai_kursus.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.kemaskini.senarai_kursus.index') }}">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.kemaskini.nama_pelajar.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.kemaskini.nama_pelajar.index') }}">
                            ...
                            <span class="menu-title">Nama Pelajar (Terjemahan)</span>
                        </a>
                    </div>
                </div>
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ Request::routeIs('pengurusan.peperiksaan.kemaskini.subjek_arab.index') ? 'active' : '' }}" href="{{ route('pengurusan.peperiksaan.kemaskini.subjek_arab.index') }}">
                            ...
                            <span class="menu-title">Subjek Arab</span>
                        </a>
                    </div>
                </div>
            </div>
