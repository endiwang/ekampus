        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pelajar.permohonan.sijil_tahfiz.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('masalah_penglihatan', ['0' => 'Tidak', '1' => 'Ya'], old('masalah_penglihatan'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('masalah_penglihatan') ? 'is-invalid':''),'id'=>'masalah_penglihatan' ]) }}
                        ...
                        <div class="card mt-2">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('siri_id', $siri_peperiksaan, old('siri_id'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('siri_id') ? 'is-invalid':''),'id'=>'siri_id' ]) }}
                        ...
                        <div class="card mt-2">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('nama_tahfiz',old('nama_tahfiz'),['class' => 'form-control form-control-sm '.($errors->has('nama_tahfiz') ? 'is-invalid':''), 'id' =>'nama_tahfiz','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('poskod_tahfiz',old('poskod_tahfiz'),['class' => 'form-control form-control-sm '.($errors->has('poskod_tahfiz') ? 'is-invalid':''), 'id' =>'poskod_tahfiz','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('negeri_tahfiz', $negeriSelection, old('negeri_tahfiz'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('negeri_tahfiz') ? 'is-invalid':''),'id'=>'negeri_tahfiz' ]) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('jenis_pengajian', ['1' => 'Kerajaan', '2' => 'Swasta'], old('jenis_pengajian'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('jenis_pengajian') ? 'is-invalid':''),'id'=>'jenis_pengajian' ]) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('tahun_mula',old('tahun_mula'),['class' => 'form-control form-control-sm '.($errors->has('tahun_mula') ? 'is-invalid':''), 'id' =>'tahun_mula','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('tahun_tamat',old('tahun_tamat'),['class' => 'form-control form-control-sm '.($errors->has('tahun_tamat') ? 'is-invalid':''), 'id' =>'tahun_tamat','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('tahap_pencapaian_hafazan',old('tahap_pencapaian_hafazan'),['class' => 'form-control form-control-sm '.($errors->has('tahap_pencapaian_hafazan') ? 'is-invalid':''), 'id' =>'tahap_pencapaian_hafazan','autocomplete' => 'off']) }}
                        ...
                        <div class="card mt-2">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('dokumen_sokongan', 'Dokumen Sokongan', ['class' => 'fs-7 fw-semibold form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
                                ...
                                {{-- <div class="row fv-row mb-2" >
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('resit_bayaran', 'Resit Bayaran', ['class' => 'fs-7 fw-semibold form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
