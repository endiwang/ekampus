...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <form class="form" action="{{ route('pemohon.permohonan_sijil_tahfiz.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::text('name', $maklumat_pemohon ? $maklumat_pemohon->name : '',['class' => 'form-control form-control-lg '.($errors->has('name') ? 'is-invalid':'')]) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::text('ic_no',$user->username,['class' => 'form-control form-control-lg','disabled']) }}
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                ...
                                {{ Form::text('dob', $maklumat_pemohon ? Carbon\Carbon::parse($maklumat_pemohon->dob)->format('d/m/Y') : '',['class' => 'form-control form-control-lg '.($errors->has('dob') ? 'is-invalid':''), 'id' =>'tarikh_lahir','onkeydown' =>'return false','autocomplete' => 'off']) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::email('email',$user->email,['class' => 'form-control form-control-lg', 'disabled']) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::textarea('address',$maklumat_pemohon ? $maklumat_pemohon->address : '',['class' => 'form-control form-control-lg '.($errors->has('address') ? 'is-invalid':''), 'rows'=>'4']) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::number('postcode',$maklumat_pemohon ? $maklumat_pemohon->postcode : '',['class' => 'form-control form-control-lg '.($errors->has('postcode') ? 'is-invalid':'')]) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('negeri_id', $negeri, $maklumat_pemohon ? $maklumat_pemohon->negeri_id : '', ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-lg '.($errors->has('negeri_id') ? 'is-invalid':'')]) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::number('phone_no',$maklumat_pemohon ? $maklumat_pemohon->phone_no : '',['class' => 'form-control form-control-lg '.($errors->has('phone_no') ? 'is-invalid':'')]) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('gender', ['L' => 'Lelaki (Male)', 'P' => 'Perempuan (Female)'], $maklumat_pemohon ? $maklumat_pemohon->gender : '', ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-lg '.($errors->has('gender') ? 'is-invalid':'')]) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('masalah_penglihatan', ['0' => 'Tidak', '1' => 'Ya'], old('masalah_penglihatan'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('masalah_penglihatan') ? 'is-invalid':''),'id'=>'masalah_penglihatan' ]) }}
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('siri_id', $siri_peperiksaan, old('siri_id'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('siri_id') ? 'is-invalid':''),'id'=>'siri_id' ]) }}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('pusat_peperiksaan_id', [], old('pusat_peperiksaan_id'), ['placeholder' => 'Sila Pilih','data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('pusat_peperiksaan_id') ? 'is-invalid':''),'id'=>'pusat_peperiksaan_id' ]) }}
                        ...
                        <div class="row mb-6" id="ppnegeridiv">
                            ...
                            <div class="col-lg-8 fv-row">
                                {{ Form::select('pusat_peperiksaan_negeri_id', [], old('pusat_peperiksaan_negeri_id'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('pusat_peperiksaan_negeri_id') ? 'is-invalid':''),'id'=>'pusat_peperiksaan_negeri_id' ]) }}
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <div class="card-body border-top p-9">
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::text('nama_tahfiz',old('nama_tahfiz'),['class' => 'form-control form-control-lg '.($errors->has('nama_tahfiz') ? 'is-invalid':''), 'id' =>'nama_tahfiz','autocomplete' => 'off']) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    <textarea name="alamat_tahfiz" class="form-control" id="kt_docs_maxlength_textarea" placeholder="" rows="3"></textarea>
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::text('poskod_tahfiz',old('poskod_tahfiz'),['class' => 'form-control form-control-lg '.($errors->has('poskod_tahfiz') ? 'is-invalid':''), 'id' =>'poskod_tahfiz','autocomplete' => 'off']) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::select('negeri_tahfiz', $negeri, old('negeri_tahfiz'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('negeri_tahfiz') ? 'is-invalid':''),'id'=>'negeri_tahfiz' ]) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::select('jenis_pengajian', ['1' => 'Kerajaan', '2' => 'Swasta'], old('jenis_pengajian'), ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl-lg form-select '.($errors->has('jenis_pengajian') ? 'is-invalid':''),'id'=>'jenis_pengajian' ]) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::text('tahun_mula',old('tahun_mula'),['class' => 'form-control form-control-lg '.($errors->has('tahun_mula') ? 'is-invalid':''), 'id' =>'tahun_mula','autocomplete' => 'off']) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::text('tahun_tamat',old('tahun_tamat'),['class' => 'form-control form-control-lg '.($errors->has('tahun_tamat') ? 'is-invalid':''), 'id' =>'tahun_tamat','autocomplete' => 'off']) }}
                        ...
                        <div class="row mb-6" >
                            ...
                            <div class="col-lg-8 fv-row">
                                    {{ Form::text('tahap_pencapaian_hafazan',old('tahap_pencapaian_hafazan'),['class' => 'form-control form-control-lg '.($errors->has('tahap_pencapaian_hafazan') ? 'is-invalid':''), 'id' =>'tahap_pencapaian_hafazan','autocomplete' => 'off']) }}
            ...
            <div class="card shadow-none mt-2">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <div class="card-body border-top p-9">
                        <div class="row mb-6" >
                            <div class="col-lg-4">
                                {{ Form::label('mykad', 'MyKad', ['class' => 'col-form-label required fw-semibold fs-6 pb-0 pt-0']) }}
                            </div>
                            <div class="col-lg-8 fv-row">
                                <div class="w-100">
                        ...
                        <div class="row mb-6" >
                            <div class="col-lg-4">
                                {{ Form::label('dokumen_sokongan', 'Dokumen Sokongan', ['class' => 'col-form-label required fw-semibold fs-6 pb-0 pt-0']) }}
                            </div>
                            <div class="col-lg-8 fv-row">
                                <div class="w-100">
...
$(document).ready(function () {
    if($("#siri_id").val() != null || $("#siri_id").val() != '')
    {
