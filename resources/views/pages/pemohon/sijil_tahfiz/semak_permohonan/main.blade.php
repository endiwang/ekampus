            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card" id="advanceSearch">
                    <div class="card-body py-5">
                        <form class="form" action="{{ route('pemohon.permohonan_sijil_tahfiz.semakan_permohonan_sijil_tahfiz.index')}}" method="get">
                            <div class="card">
                                <div class="card-body py-5">
                                    ...
                                    <div class="row fv-row mb-2" >
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-center justify-content-end">
                                                ...
                                                <a href="{{ route('pemohon.permohonan_sijil_tahfiz.semakan_permohonan_sijil_tahfiz.index') }}" class="btn btn-sm btn-light">Set Semula</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
