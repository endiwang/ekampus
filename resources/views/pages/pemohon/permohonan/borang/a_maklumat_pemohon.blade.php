    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        <div class="card-body border-top p-9">
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8 fv-row">
                    <input class="form-control " id="tarikh_lahir"/>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8 fv-row">
                    {{ Form::select('keturunan', ['M' => 'Melayu', 'C' => 'Cina', 'I' =>'India'], null, ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-lg ']) }}
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8 fv-row">
                    {{ Form::text('saiz_baju','',['class' => 'form-control form-control-lg ']) }}
                </div>
            </div>
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8 fv-row">
                    {{ Form::select('kewarganegaraan', ['W' => 'Warganegara', 'BW' => 'Bukan Warganegara'], null, ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-lg ']) }}
                    {{ Form::text('bukan_warganegaraan','',['class' => 'form-control form-control-lg  mt-2']) }}
