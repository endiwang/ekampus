                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" form="no_matrik" class="btn btn-primary" data-bs-dismiss="modal">Daftar No Matrik</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        function getMaklumatPelajar(d){
            ...
            $.ajax({
               url: '{{ route('pengurusan.kbg.pengurusan.pendaftaran_no_matrik.getMaklumatPelajar') }}',
               type: 'post',
               data: {
