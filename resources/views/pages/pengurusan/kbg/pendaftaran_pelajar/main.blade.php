                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="pilih()">Sahkan Pendaftaran</button>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        function pilih(){
            Swal.fire({
                icon:'question',
                title: 'Adakah anda pasti untuk membuat pendaftaran ke atas pelajar ini?',
