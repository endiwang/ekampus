                    ...
                    <form class="form" action="{{ route('pengurusan.kbg.pengurusan.senarai_tapisan_permohonan.proses_pemilihan')}}" method="get">
                        <div class="card">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('', 'Subjek dan Gred SPM', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="row mb-lg-2">
                                            @foreach ($subjek_spm as $subjek)
                                                ...
                                                <div class="col-lg-2 mt-md-3 mt-3 mt-lg-3 fv-row">
                                                    {{ Form::select($subjek->slug, $pilihan_keputusan , Request::get($subjek->slug), ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-sm']) }}
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
