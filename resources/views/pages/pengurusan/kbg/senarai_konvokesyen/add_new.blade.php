            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card" id="advanceSearch">
                    ...
                    <div class="card-body py-5">
                        <form class="form" action="{{ route('pengurusan.kbg.konvokesyen.store') }}" method="post">
                            @csrf
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('tajuk_konvo',old('tajuk_konvo'),['class' => 'form-control form-control-sm '.($errors->has('tajuk_konvo') ? 'is-invalid':''), 'id' =>'tajuk_konvo','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-4">
                                    <div class="w-100">
                                        {{ Form::text('tarikh',old('tarikh'),['class' => 'form-control form-control-sm '.($errors->has('tarikh') ? 'is-invalid':''), 'id' =>'tarikh','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                ...
                                <div class="col-md-2">
                                    <div class="w-100">
                                        {{ Form::text('masa',old('masa'),['class' => 'form-control form-control-sm '.($errors->has('masa') ? 'is-invalid':''), 'id' =>'masa','autocomplete' => 'off']) }}
                                        @error('masa') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="w-100">
                                        {{ Form::select('waktu',['pagi'=>'Pagi','petang'=>'Petang'], null, ['class' =>'form-control form-control-sm '.($errors->has('waktu') ? 'is-invalid':'')]) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('nama_tempat', $model->nama ?? old('nama_tempat'),['class' => 'form-control form-control-sm '.($errors->has('nama_tempat') ? 'is-invalid':''), 'id' =>'nama_tempat','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::textarea('alamat_tempat', $model->nama ?? old('alamat_tempat'),['class' => 'form-control form-control-sm '.($errors->has('alamat_tempat') ? 'is-invalid':''), 'id' =>'alamat_tempat_pendaftaran','autocomplete' => 'off', 'rows'=>'4']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::select('status',[0=>'Proses Penyediaan Maklumat',1=>'Semakan Oleh Pelajar',2=>'Telah Selesai'], null, ['class' =>'form-control form-control-sm '.($errors->has('status') ? 'is-invalid':'')]) }}
                            ...
                            <div class="row">
                                <div class="col-md-9 offset-md-3">
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('pengurusan.kbg.pengurusan.konvokesyen.index') }}" class="btn btn-sm btn-light">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </form>
