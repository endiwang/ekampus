    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                <h3 class="card-title">Senarai Nama Pemohon</h3>
            </div>
    ...
    var KTDatatablesServerSide = function () {
        ...
        var initDatatable = function () {
            dt = $("#senarai_pemohon_table").DataTable({
                ...
                ajax: {
                    url: "{!! route('pengurusan.kbg.pengurusan.tawaran.pilih_pelajar_api', $tawaran->id) !!}",
                },
                columns: [
                    { data: 'id' },
                    { data: 'nama', data:'nama', orderable: true, },
                    { data: 'jantina', data:'jantina', orderable: true, },
                    { data: 'no_ic', data:'no_ic', orderable: true, },
                    { data: 'jumlah', data:'temuduga_markah.jumlah', orderable: true, },
                ],
                columnDefs: [
                    {
                        targets: 0,
