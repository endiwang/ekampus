            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="card" id="advanceSearch">
                    ...
                    <div class="card-body py-5">
                        <form class="form" action="{{ route('pengurusan.kbg.tawaran.store') }}" method="post">
                            @csrf
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('tajuk_tawaran',old('tajuk_tawaran'),['class' => 'form-control form-control-sm '.($errors->has('tajuk_tawaran') ? 'is-invalid':''), 'id' =>'tajuk_tawaran','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::select('tawaran_type',['B'=>'Tawaran Pengambilan','R'=>'Tawaran Rayuan'], null, ['placeholder' => 'Sila Pilih','class' =>'form-control form-control-sm '.($errors->has('tawaran_type') ? 'is-invalid':'')]) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('tarikh_surat',old('tarikh_surat'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_surat') ? 'is-invalid':''), 'id' =>'tarikh_surat','onkeydown' =>'return false','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('tarikh_pendaftaran',old('tarikh_pendaftaran'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_pendaftaran') ? 'is-invalid':''), 'id' =>'tarikh_pendaftaran','onkeydown' =>'return false','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('masa_pendaftaran',old('masa_pendaftaran'),['class' => 'form-control form-control-sm '.($errors->has('masa_pendaftaran') ? 'is-invalid':''), 'id' =>'masa_pendaftaran','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('nama_tempat_pendaftaran', $model->nama ?? old('nama_tempat_pendaftaran'),['class' => 'form-control form-control-sm '.($errors->has('nama_tempat_pendaftaran') ? 'is-invalid':''), 'id' =>'nama_tempat_pendaftaran','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::textarea('alamat_tempat_pendaftaran', $model->nama ?? old('alamat_tempat_pendaftaran'),['class' => 'form-control form-control-sm '.($errors->has('alamat_tempat_pendaftaran') ? 'is-invalid':''), 'id' =>'alamat_tempat_pendaftaran','autocomplete' => 'off', 'rows'=>'4']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::select('status_kemasukan',[1=>'Tidak Aktif (Proses Penyediaan)',2=>'Aktif (Proses Pendaftaran Pelajar)',3=>'Arkib'], null, ['class' =>'form-control form-control-sm '.($errors->has('status_kemasukan') ? 'is-invalid':'')]) }}
                            ...
                            <div class="row">
                                <div class="col-md-9 offset-md-3">
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('pengurusan.kbg.pengurusan.tawaran.index') }}" class="btn btn-sm btn-light">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </form>
