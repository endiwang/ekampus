        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.pengajian_sepanjang_hayat.tetapan.sesi_peperiksaan_sijil_tahfiz.store')}}" method="post">
                        @csrf
                        <div class="card">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_permohonan_dibuka',old('tarikh_permohonan_dibuka'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_permohonan_dibuka') ? 'is-invalid':''), 'id' =>'tarikh_permohonan_dibuka','onkeydown' =>'return false','autocomplete' => 'off']) }}
