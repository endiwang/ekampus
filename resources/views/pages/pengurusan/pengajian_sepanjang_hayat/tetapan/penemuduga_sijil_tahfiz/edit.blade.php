        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.pengajian_sepanjang_hayat.tetapan.penemuduga_sijil_tahfiz.update', $id)}}" method="post">
                        @method('PATCH')
                        @csrf
                        <div class="card">
                            <div class="card-body py-5">
                                        ...
                                        <div class="w-100">
                                            <select name="tetapan_peperiksaan_sijil_tahfiz_id" class="form-select" data-control="select2" data-placeholder="Sila Pilih" data-allow-clear="true" data-hide-search="false" id="tetapan_peperiksaan_sijil_tahfiz_id">
                                                @foreach ($tetapanpeperiksaansijiltahfizs as $tetapanpeperiksaansijiltahfiz)
                                                    <option value="{{ $tetapanpeperiksaansijiltahfiz->id }}" @if ($tetapanpeperiksaansijiltahfiz->id == $penemuduga->tetapan_peperiksaan_sijil_tahfiz_id) selected @endif>{{ $tetapanpeperiksaansijiltahfiz->siri }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('pusat_peperiksaan_id', $pusatPeperiksaans, $penemuduga->pusat_peperiksaan_id, ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('pusat_peperiksaan_id') ? 'is-invalid':''),'id'=>'pusat_peperiksaan_id' ]) }}
                                ...
                                <div class="row fv-row mb-2" id="ppnegeridiv">
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('pusat_peperiksaan_negeri_id', $pusatPeperiksaanNegeris, $penemuduga->pusat_peperiksaan_negeri_id, ['placeholder' => 'Sila Pilih', 'data-control'=>'select2', 'class' =>'form-contorl form-select form-select-sm '.($errors->has('pusat_peperiksaan_negeri_id') ? 'is-invalid':''),'id'=>'pusat_peperiksaan_negeri_id' ]) }}
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                {{ Form::checkbox('status', 1, ($penemuduga->status == 0 ? 0:1), ['class' => 'form-check-input h-25px w-60px mt-1']); }}
