        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.pengajian_sepanjang_hayat.tetapan.majlis_penyerahan_sijil_tahfiz.update',$id)}}" method="post">
                        @method('PATCH')
                        @csrf
                        <div class="card">
                            <div class="card-body py-5">
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('nama',@$tetapan_majlis->nama,['class' => 'form-control form-control-sm '.($errors->has('nama') ? 'is-invalid':''), 'id' =>'nama','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('siri',@$tetapan_majlis->siri,['class' => 'form-control form-control-sm '.($errors->has('siri') ? 'is-invalid':''), 'id' =>'siri','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::number('tahun',@$tetapan_majlis->tahun,['class' => 'form-control form-control-sm no-spin '.($errors->has('tahun') ? 'is-invalid':''), 'id' =>'tahun','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('no_fail_surat',@$tetapan_majlis->no_fail_surat,['class' => 'form-control form-control-sm '.($errors->has('no_fail_surat') ? 'is-invalid':''), 'id' =>'no_fail_surat','autocomplete' => 'off']) }}
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            <select name="pusat_pengajian_id" class="form-select" data-control="select2" data-placeholder="Sila Pilih" data-allow-clear="true" data-hide-search="false" id="pusat_pengajian_id">
                                                ...
                                                @if($pusat_pengajian->id == @$tetapan_majlis->pusat_pengajian_id)
                                                    <option value="{{ $pusat_pengajian->id }}" selected>{{ $pusat_pengajian->nama }}</option>
                                                @else
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_surat_mula',\Carbon\Carbon::createFromFormat('Y-m-d',@$tetapan_majlis->tarikh_surat_mula)->format('d/m/Y'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_surat_mula') ? 'is-invalid':''), 'id' =>'tarikh_surat_mula','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_surat_akhir',\Carbon\Carbon::createFromFormat('Y-m-d',@$tetapan_majlis->tarikh_surat_akhir)->format('d/m/Y'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_surat_akhir') ? 'is-invalid':''), 'id' =>'tarikh_surat_akhir','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_majlis_mula',\Carbon\Carbon::createFromFormat('Y-m-d',@$tetapan_majlis->tarikh_majlis_mula)->format('d/m/Y'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_majlis_mula') ? 'is-invalid':''), 'id' =>'tarikh_majlis_mula','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_majlis_akhir',\Carbon\Carbon::createFromFormat('Y-m-d',@$tetapan_majlis->tarikh_majlis_akhir)->format('d/m/Y'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_majlis_akhir') ? 'is-invalid':''), 'id' =>'tarikh_majlis_akhir','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::time('masa_majlis', @$tetapan_majlis->masa_majlis,['class' => 'form-control form-control-sm '.($errors->has('masa_majlis') ? 'is-invalid':''), 'id' =>'masa_majlis','onkeydown' =>'return true','autocomplete' => 'off','required' => 'required']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('staff_id', $staffs, @$tetapan_majlis->staff_id, ['placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('staff_id') ? 'is-invalid':''),'id'=>'staff_id' ]) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="w-100">
                                            {{ Form::text('tarikh_cetakan',\Carbon\Carbon::createFromFormat('Y-m-d',@$tetapan_majlis->tarikh_cetakan)->format('d/m/Y'),['class' => 'form-control form-control-sm '.($errors->has('tarikh_cetakan') ? 'is-invalid':''), 'id' =>'tarikh_cetakan','onkeydown' =>'return false','autocomplete' => 'off']) }}
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                {{ Form::checkbox('status', 1, (@$tetapan_majlis->status == 0 ? false:true), ['class' => 'form-check-input h-25px w-60px mt-1']); }}
