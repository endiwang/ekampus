        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
             ...
             <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.peperiksaan.kemaskini_markah.index')}}" method="get">
                        <div class="card">
                            <div class="card-body py-5">
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('kursus', $subjects, Request::get('kursus'), ['data-control'=>'select2', 'placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm','id'=>'kursus' ]) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('syukbah', $syukbah, Request::get('sesi_kemasukan'), ['data-control'=>'select2', 'placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm','id'=>'sesi_kemasukan' ]) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="row fv-row mb-2" >
                                ...
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            <a href="{{ route('pengurusan.peperiksaan.kemaskini_markah.index') }}" class="btn btn-sm btn-light">Set Semula</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
