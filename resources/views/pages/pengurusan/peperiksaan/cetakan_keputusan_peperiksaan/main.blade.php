        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
             ...
             <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.peperiksaan.cetakan_keputusan_peperiksaan.download_keputusan')}}" method="post">
                        @csrf
                        <div class="card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-center justify-content-end">
                                            <button id="kt_share_earn_link_copy_button" class="btn btn-success btn-sm fw-bold flex-shrink-0 me-3">
                                                <i class="fa-solid fa-circle-down" style="vertical-align: initial"></i>Muat Turun
                                            </button>
                                            <a href="{{ route('pengurusan.peperiksaan.cetakan_keputusan_peperiksaan.index') }}" class="btn btn-sm btn-light">Set Semula</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
