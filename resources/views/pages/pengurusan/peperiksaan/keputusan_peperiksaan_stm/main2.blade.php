                    ...
                    <div class="card">
                        <div class="card-body py-5">
                            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('pengurusan.peperiksaan.keputusan_peperiksaan_stm.index') }}">Temuduga Aktif</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="{{ route('pengurusan.peperiksaan.keputusan_peperiksaan_stm.temuduga_terdahulu') }}">Temuduga Permohonan Terdahulu</a>
                                </li>
                            </ul>
