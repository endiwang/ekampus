                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-start" data-kt-docs-table-toolbar="base">
                            <!--begin::Add customer-->
                            <a href="{{ route('pengurusan.peperiksaan.keputusan_peperiksaan_stm.export_senarai',$temuduga->id) }}" class="btn btn-sm btn-success me-5" data-bs-toggle="tooltip" target="_blank">
                                <i class="fa fa-print"></i>
                                Cetak Keputusan Temuduga
                            </a>

                            <a href="{{ route('pengurusan.peperiksaan.keputusan_peperiksaan_stm.index') }}" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip">
                                Kembali
                            </a>
                            <!--end::Add customer-->
                        </div>
...
function kira_markah(id)
    {
        ...
        }else if(isNaN(hafazan))
        {
            ...
            $.ajax({
                    url: "{{route('pengurusan.peperiksaan.keputusan_peperiksaan_stm.store')}}",
                    type: "POST",
                    data: {
                                id: id,
