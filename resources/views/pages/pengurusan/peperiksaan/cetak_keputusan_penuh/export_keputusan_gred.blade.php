            ...
            <tbody>
                @forelse ($data as $value)
                    <tr>
                        ...
                        <td style="text-align: center;">{{ $value->jam_kredit ?? '0' }}</td>
                        <td style="text-align: center;">{{ number_format($value->jumlah_markah,2) ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ number_format($value->png,2) ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ $value->jumlah_kredit_keseluruhan ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ number_format($value->jumlah_markah_keseluruhan,2) ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ number_format($value->pngk,2) ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ $value->keputusan ?? 'N/A' }}</td>
                        <td style="text-align: center;">{{ $value->pangkat ?? 'N/A' }}</td>
                        <td style="text-align: center;">{{ number_format($value->jumlah_markah_semester,2) ?? '0.00' }}</td>
                        <td style="text-align: center;">{{ $value->jam_kredit_semester ?? '0' }}</td>
