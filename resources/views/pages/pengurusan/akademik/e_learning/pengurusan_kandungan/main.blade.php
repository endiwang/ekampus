        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="row g-5 g-xl-10 mb-3 mb-xl-4">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <form class="form" action="{{ route('pengurusan.akademik.e_learning.pengurusan_kandungan.index')}}" method="get">
                        <div class="card">
                            <div class="card-body py-5">
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('nama_kandungan', 'Nama Kandungan', ['class' => 'fs-7 fw-semibold form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('nama_kandungan', Request::get('nama_kandungan') ,['class' => 'form-control form-control-sm', 'id' =>'nama_kandungan','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('kursus', Request::get('kursus') ,['class' => 'form-control form-control-sm', 'id' =>'kursus','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            <a href="{{ route('pengurusan.akademik.e_learning.pengurusan_kandungan.index') }}" class="btn btn-sm btn-light">Set Semula</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
