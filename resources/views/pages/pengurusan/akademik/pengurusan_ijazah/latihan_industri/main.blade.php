                        ...
                        <div class="card">
                            <div class="card-body py-5">
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('pelajar', Request::get('pelajar') ,['class' => 'form-control form-control-sm', 'id' =>'pelajar','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('nombor_rujukan', 'Nombor Rujukan (Latihan Industri)', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('nombor_rujukan', Request::get('nombor_rujukan') ,['class' => 'form-control form-control-sm', 'id' =>'nombor_rujukan','onkeydown' =>'return true','autocomplete' => 'off']) }}
