                ...
                <div class="card" id="advanceSearch">
                    ...
                    <div class="card-body py-5">
                        ...
                        <form class="form" action="{{ $action }}" method="post">
                            ...
                            <div class="row fv-row mb-2" >
                                <div class="col-md-3 text-md-end">
                                    {{ Form::label('alamat', 'Alamat', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('email', $model->no_tel ?? old('email'),['class' => 'form-control form-control-sm '.($errors->has('email') ? 'is-invalid':''), 'id' =>'email','onkeydown' =>'return true','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                <div class="col-md-3 text-md-end">
                                    {{ Form::label('gred', 'Gred', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::select('gred', $departments, $model->gred, ['placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('gred') ? 'is-invalid':''), 'data-control'=>'select2' ]) }}
