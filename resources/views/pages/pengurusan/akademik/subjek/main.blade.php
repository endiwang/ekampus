                    ...
                    <div class="card" id="advanceSearch">
                        <div class="card-body py-5">
                            <form id="kt_ecommerce_settings_general_form" class="form" action="#">
                                ...
                                <div class="row fv-row mb-2" v-show="show_section_2">
                                    <div class="col-md-3 text-md-end">
                                        {{ Form::label('search_kursus', 'Kursus', ['class' => 'fs-6 fw-semibold form-label mt-2']) }}
                                    </div>
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('search_kursus','',['placeholder' => 'Cari Kursus','class' => 'form-control form-control-sm']) }}
                                        </div>
                                    </div>
                                </div>
