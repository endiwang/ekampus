                    ...
                    <div class="card-body py-5">
                        <form class="form" action="{{ $action }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('syukbah', $model->syukbah->nama ?? '' ,['class' => 'form-control form-control-sm disabled', 'id' =>'syukbah','onkeydown' =>'return false','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::select('kelas', $classes, $model->kelas_id, ['placeholder' => 'Pilih Kelas','class' =>'form-contorl form-select form-select-sm', 'data-control'=>'select2' ]) }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9 offset-md-3">
                                    <div class="d-flex">
                                        ...
                                        <a href="{{ route('pengurusan.akademik.kelas_pelajar.index') }}" class="btn btn-sm btn-light">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </form>
