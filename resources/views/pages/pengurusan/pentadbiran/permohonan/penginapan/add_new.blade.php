                ...
                <div class="card" id="advanceSearch">
                    ...
                    @endif
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        ...
                                        {{ Form::select('bilik', $selectbilik, $model->bilik, ['placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('bilik') ? 'is-invalid':'') ]) }}                                                                                
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::date('tarikh', $model->tarikh_masuk ?? '' ,['class' => 'form-control form-control-sm', 'id' =>'peraturan_akademik','onkeydown' =>'return true','autocomplete' => 'off']) }}
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::date('tarikh_keluar', $model->tarikh_keluar ?? '' ,['class' => 'form-control form-control-sm', 'id' =>'peraturan_akademik','onkeydown' =>'return true','autocomplete' => 'off']) }}
