                ...
                <div class="card" id="advanceSearch">
                    ...
                    @endif
                            ...
                            <div class="row fv-row mb-2" >
                                ...
                                <div class="col-md-9">
                                    <div class="w-100">
                                    {{ Form::select('status', $status, $model->status, ['disabled' => 'disabled','placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('kategori') ? 'is-invalid':'') ]) }}
                            ...
                            <div class="row fv-row mb-2" >
                                <div class="col-md-3 text-md-end">
                                    {{ Form::label('pelulus', 'Nama Pelulus', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                                        {{ Form::text('pelulus', data_get($model,'approvedby.staff.nama') ?? '' ,['disabled' => 'disabled','class' => 'form-control form-control-sm', 'id' =>'peraturan_akademik','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                        @error('username') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>
                                </div>
                            </div>
