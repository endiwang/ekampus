                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="card">
                        <div class="card-body py-5">
                            <form class="form" action="{{ route('pengurusan.pentadbir_sistem.pusat_temuduga.update',$pusat_temuduga->id)}}" method="post">
                                @method('PUT')
                                @csrf
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('nama_pusat_temuduga',$pusat_temuduga->nama ,['class' => 'form-control form-control-sm']) }}
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            <label class="form-check form-switch form-check-custom form-check-solid">
                                                ...
                                                {{ Form::checkbox('status', '0', ($pusat_temuduga->status == 0 ? true:false), ['class' => 'form-check-input h-25px w-60px']); }}
