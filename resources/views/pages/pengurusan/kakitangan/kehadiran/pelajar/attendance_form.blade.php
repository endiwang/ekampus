            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Kehadiran Bagi Subjek {{ $subject->nama }} [Tarikh: {{ Utils::formatDate(now()) }}]</h3>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ $action }}" method="post">
                            ...
                            <div class="row fv-row mb-2" >
                                <div class="col-md-3 text-md-end">
                                    {{ Form::label('no_matrik', 'Sila masukkan no matrik', ['class' => 'fs-7 fw-semibold required form-label mt-2']) }}
                                </div>
                                <div class="col-md-9">
                                    <div class="w-100">
                            ...
                            <input type="hidden" name="subjek_id" value="{{ $subject->id }}">
