                ...
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <div class="card" id="advanceSearch">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Jaminan Kualiti</h3>
                        </div>
                        <div class="card-body py-5">
                            <form class="form" action="{{ route('pengurusan.kualiti.kualiti.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('category', $catMaklumat, null, ['placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('tahun_bermula') ? 'is-invalid':'') ]) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('name', old('name'),['class' => 'form-control form-control-sm '.($errors->has('name') ? 'is-invalid':''), 'id' =>'no_ic','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::text('description', old('description'),['class' => 'form-control form-control-sm '.($errors->has('name') ? 'is-invalid':''), 'id' =>'no_ic','onkeydown' =>'return true','autocomplete' => 'off']) }}
                                ...
                                <div class="row fv-row mb-2" >
                                    ...
                                    <div class="col-md-9">
                                        <div class="w-100">
                                            {{ Form::select('docType', $jenisDoc, null, ['placeholder' => 'Sila Pilih','class' =>'form-contorl form-select form-select-sm '.($errors->has('tahun_bermula') ? 'is-invalid':'') ]) }}
                                ...
                                <div class="row">
                                    <div class="col-md-9 offset-md-3">
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('pengurusan.pentadbir_sistem.sesi.index') }}" class="btn btn-sm btn-light">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
