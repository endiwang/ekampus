...
@section('content')
    ...
    <div class="scroll-y flex-column-fluid px-10 py-10" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header_nav" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true" style="background-color:#D5D9E2; --kt-scrollbar-color: #d9d0cc; --kt-scrollbar-hover-color: #d9d0cc">
        ...
        <div id="#kt_app_body_content" style="background-color:#D5D9E2; font-family:Arial,Helvetica,sans-serif; line-height: 1.5; min-height: 100%; font-weight: normal; font-size: 15px; color: #2F3044; margin:0; padding:0; width:100%;">
            <div style="background-color:#ffffff; padding: 45px 0 34px 0; border-radius: 24px; margin:40px auto; max-width: 940px;">
                    ...
                    <tbody>
                            ...
                            <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                ...
                                <div style="text-align:center; margin:0 15px 34px 15px">
                                    ...
                                    <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                        <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">{{ $form->title }}</p>
                                    </div>
                                    <!--end:Text-->
                                </div>
                                <!--end:Email content-->
                        ...
                        <tr>
                            <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                                ...
                                <form action="{{ route('pengurusan.komunikasi_korporat.kaji_selidik.fill_store', $form->id) }}" method="POST" enctype="multipart/form-data" id="fill-form">
                                    @method('PUT')
                                @if (isset($array))
                                        ...
                                        @foreach ($rows as $row_key => $row)
                                            ...
                                            <!--begin::Input wrapper-->
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                        <span @if ($row->required) class="required" @endif>{{ $row->label }}</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <div class="d-flex align-items-center mt-3">
                                                        ...
                                                        <label class="form-check form-check-custom form-check-inline form-check-solid me-5 is-valid">
                                                            ...
                                                            <span class="fw-semibold ps-2 fs-6" for="{{ $row->name . '_' . $key }}">{{ $options->label }}</span>
                                                        </label>
                                                        @endforeach
                                            ...
                                            @elseif($row->type == 'paragraph')
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <!--Paragraph-->
                                                    <div class="fs-6 fw-bold text-gray-800 mb-2" style="text-align: initial">
                                                        <span class="me-2">{{ html_entity_decode($row->label) }}</span>
                                                    </div>
                                            ...
                                            @elseif($row->type == 'header')
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <!--Header-->
                                                    <div class="fs-2hx fw-bold text-gray-800 mb-2" style="text-align: initial">
                                                        <span class="me-2">{{ html_entity_decode($row->label) }}</span>
                                                    </div>
...
@section('script')
    <script>
        ...
        function submitForm(formData) {
            ...
            $.ajax({
                type: "POST",
                url: '{{ route('pengurusan.komunikasi_korporat.kaji_selidik.fill_store', $form->id) }}',
                data: formData,
                processData: false,
                contentType: false,
